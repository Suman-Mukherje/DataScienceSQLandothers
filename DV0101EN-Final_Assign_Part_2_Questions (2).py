...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        #unemp_sales1 = recession_data.groupby('unemployment_rate')(['Vehicle_Type','Automobile_Sales']).mean().reset_index()
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata,x='Vehicle_Type',y='Automobile_Sales',title='Average Vehicles Sold in the year {}'.format(input_year)))
